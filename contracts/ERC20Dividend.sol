...
contract ERC20Dividend is Ownable, IERC20 {
    ...
    function _transfer(
        ...
        require(
            isOpen || sender == owner() || recipient == owner(),
            "Not Open"
        );
        ...
        require(amount <= _maxTxAmount || _isExcludedFromMaxTx[sender]);
    ...
    function createSweepablePair(IEmpireFactory _factory, bool update)
        external
        onlyOwner
    {
        PairType pairType = address(this) < uniswapV2Router.WETH()
            ? PairType.SweepableToken1
            : PairType.SweepableToken0;
        sweepablePair = _factory.createPair(
